    ...
    <div class="row">
        <div class="col-xs-12 ">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-externa">
                    <form class="form-horizontal" method="POST" action="{{ route('fazer-transferencia-externa') }}">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" placeholder="Agência" name="agencia" required autofocus>
                            </div>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="Conta" name="conta" required autofocus>
                            </div>
                        </div>
